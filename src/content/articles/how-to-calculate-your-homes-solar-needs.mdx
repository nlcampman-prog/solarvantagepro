...
2.  **Calculate the Daily Average:** Divide your annual kWh total by 365 days. 
    ...
    *   $10,950 \text{ kWh} \div 365 \text{ days} = 30 \text{ kWh per day}$.
...
### The Formula:
$$\text{Array Size (kW)} = \left( \frac{\text{Daily kWh Need}}{\text{Peak Sun Hours}} \right) \times 1.25$$

### Applying our example:
$$\text{Array Size} = \left( \frac{30 \text{ kWh}}{4.2 \text{ hours}} = 7.14 \text{ kW} \right) \times 1.25 = 8.92 \text{ kW}$$
...
### The Formula:
$$\text{Number of Panels} = \frac{\text{Array Size in Watts}}{\text{Panel Wattage}}$$

### Applying our example (using 400W panels):
$$\text{Number of Panels} = \frac{8,920 \text{ Watts}}{400 \text{ Watts}} = 22.3$$
...
*   **True Off-Grid Living:** Off-grid homes should plan for at least **3 days of autonomy** to account for consecutive rainy or heavily overcast days. 
    *   $30 \text{ kWh per day} \times 3 \text{ days} = 90 \text{ kWh of storage}$.
